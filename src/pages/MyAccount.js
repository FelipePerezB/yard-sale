...
function MyAccount() {
  ...
  function handleClick() {
    ...
    setUser(
      {
        userName: !validateName.problems ? desactiveError('Name', validateName.text, setNameErrors) : activeInputError('Name', validateName.problems, setNameErrors, name),

        email: !validateEmail.problems ? desactiveError('Email', validateEmail.text, setEmailErrors) : activeInputError('Email', validateEmail.problems, setEmailErrors, email),
