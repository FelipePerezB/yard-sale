...
function Login() {
  ...
  const handleSubmit = (event) => {
    ...
    {
      userIndex !== -1 ? (user.password === data.password ? login(user) : error('La contraseña es incorrecta')) : error("No se ha encontrado el correo, para crear una cuenta presione 'Sign up'");
    }
  };
